facts("Testing SummationByParts Module (face-data integration methods)...") do
  ...
  context("Testing integratefunctional! (TriSparseFace, scalar field method)") do
    # build a two element grid and verify the accuracy of boundary integration
    for p = 1:4
  ...
  context("Testing integratefunctional! (TriSparseFace, vector field method)") do
    # build a two element grid and verify the accuracy of boundary integration
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
      sbpface = getTriFaceForDiagE(p, sbp.cub, sbp.vtx)
  ...
  context("Testing integrateBoundaryFunctional! (TriSparseFace, scalar field method)") do
    # build a two element grid and verify the accuracy of boundary integration
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
      sbpface = getTriFaceForDiagE(p, sbp.cub, sbp.vtx)
  ...
  context("Testing integrateBoundaryFunctional! (TriSparseFace, vector field method)") do
    # build a two element grid and verify the accuracy of boundary integration
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
      sbpface = getTriFaceForDiagE(p, sbp.cub, sbp.vtx)
  ...
  context("Testing boundaryintegrate! and interiorfaceintegrate! (TriSparseFace scalar field method)") do
    # build a two element grid and verify that a constant integrated over all
    # faces is zero
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
  ...
  context("Testing boundaryintegrate! and interiorfaceintegrate! (TriSparseFace vector field method)") do
    # build a two element grid and verify that a constant integrated over all
    # faces is zero
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
  ...
  context("Testing boundaryintegrate! and interiorfaceintegrate! (TetSBP vector field method)") do
    # build a five element grid and verify that a constant integrated over all
    # faces is zero
    for p = 1:4      
      sbp = getTetSBPGamma(degree=p)
  ...
  context("Testing boundaryFaceIntegrate! and interiorFaceIntegrate! (TriSparseFace scalar field method)") do
    # build a two element grid and verify that a constant integrated over all
    # faces is zero
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
  ...
  context("Testing boundaryFaceIntegrate! and interiorFaceIntegrate! (TriSparseFace vector field method)") do
    # build a two element grid and verify that a constant integrated over all
    # faces is zero
    for p = 1:4
      sbp = getTriSBPDiagE(degree=p)
  ...
  context("Testing boundaryFaceIntegrate! and interiorFaceIntegrate! (TetSBP vector field method)") do
    # build a five element grid and verify that a constant integrated over all
    # faces is zero
    for p = 1:4      
      sbp = getTetSBPGamma(degree=p)
